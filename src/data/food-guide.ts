 ...
 *
 * Static reference data for the "Ek Gıda Rehberi" (Complementary Feeding Guide) tool.
 *
 * NOTE: kg-core does not expose a REST endpoint for this tool's content.
 * This static dataset mirrors the web version's source data (WHO, AAP, Türk Pediatri
 * Derneği guidelines) and is kept here as explicit "data" — not business logic.
 * If kg-core adds an endpoint in the future, replace this file with an API call and
