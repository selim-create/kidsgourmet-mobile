...
import type { AgeGroup, MealType, DietType, SpecialCondition } from '../lib/types';
...
export async function getSpecialConditions(): Promise<SpecialCondition[]> {
  return api.get<SpecialCondition[]>(`${API_ENDPOINTS.SPECIAL_CONDITIONS}?per_page=100`, { skipAuth: true });
}
