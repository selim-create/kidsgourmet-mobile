...
const PADDING_X = 36;
const PADDING_Y = 24;
const DAYS_PER_MONTH_DISPLAY_ESTIMATE = 30;
const Y_LABEL_X = 6;
        ...
        <>
          <Svg width={chartWidth} height={CHART_HEIGHT}>
            ...
            <SvgText x={PADDING_X} y={X_LABEL_Y} fill="#6B7280" fontSize="10">
              {(chartModel.minX / DAYS_PER_MONTH_DISPLAY_ESTIMATE).toFixed(0)} ay
            </SvgText>
            <SvgText x={chartWidth - PADDING_X - MAX_X_LABEL_OFFSET} y={X_LABEL_Y} fill="#6B7280" fontSize="10">
              {(chartModel.maxX / DAYS_PER_MONTH_DISPLAY_ESTIMATE).toFixed(0)} ay
            </SvgText>
          </Svg>
